...
def play_song():
    music=name=playlist.get(ACTIVE)
...
Button(root,image=play_button,bg="#0f1a2b",bd=0,command=play_song).place(x=95,y=400)

stop_button=PhotoImage(file="stop.png")
Button(root,image=stop_button,bg="#0f1a2b",bd=0,command=mixer.music.stop).place(x=180,y=500)

pause_button=PhotoImage(file="pause.png")
Button(root,image=pause_button,bg="#0f1a2b",bd=0,command=mixer.music.pause).place(x=40,y=500)

resume_button=PhotoImage(file="resume.png")
Button(root,image=resume_button,bg="#0f1a2b",bd=0,command=mixer.music.unpause).place(x=110,y=500)
